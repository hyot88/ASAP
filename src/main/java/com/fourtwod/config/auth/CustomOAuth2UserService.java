...
import com.fourtwod.config.auth.dto.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private User saveOrUpdate(OAuthAttributes attributes) {
        User user = userRepository.findByEmailAndRegistrationId(attributes.getEmail(), attributes.getRegistrationId())

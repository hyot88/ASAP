...
@SpringBootTest
public class SchedulerFacadeDailySuccessTest {
    ...
    @Test
    @Transactional
    public void scheduler_데일리_티어포인트계산_성공케이스() {
        // 검증할 메소드
        ...
        assertThat(user.getTierPoint()).isEqualTo(80);
        ...
        // 히스토리 추가 여부 검증
        assertThat(missionHistoryDto.getMissionType()).startsWith("Quick").contains("7Day");
        ...
        assertThat(missionHistoryDto.getChangeTierPoint()).isEqualTo(280);
    }
}
